...
pub use host::{
    ...
    enumerate, enumerate_standalone, enumerator, get_backlight, get_dpi, get_dpi_info,
    get_pointer_speed, get_scroll_wheel_mode, get_smartshift_status, list_pairing_receivers,
    play_haptic, read_battery_raw, set_backlight_enabled, set_dpi, set_fn_lock, set_keyboard_color,
    set_keyboard_color_with, set_pointer_speed, set_scroll_inversion, set_scroll_resolution,
