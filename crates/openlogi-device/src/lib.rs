...
pub use write::{
    ...
    apply_litra, commands_for_light_settings, dump_features, dump_features_on,
    dump_firmware_entities, dump_firmware_entities_on, dump_reprog_controls,
    dump_reprog_controls_on, encode_litra_command, ensure_haptics_armed_on, find_litra,
    get_backlight, get_backlight_on, get_dpi, get_dpi_info, get_dpi_info_on, get_dpi_on,
    get_pointer_speed, get_pointer_speed_on, get_scroll_wheel_mode, get_scroll_wheel_mode_on,
    get_smartshift_status, get_smartshift_status_on, litra_model_for_route, matches_litra,
    play_haptic, play_haptic_on, play_presenter_haptic_on, read_battery_raw, read_battery_raw_on,
    set_backlight_enabled, set_dpi, set_dpi_on, set_fn_lock, set_fn_lock_on, set_keyboard_color,
    set_keyboard_color_on, set_keyboard_color_with, set_keyboard_color_with_on, set_pointer_speed,
    set_pointer_speed_on, set_scroll_inversion, set_scroll_inversion_on, set_scroll_resolution,
    set_scroll_resolution_on, set_scroll_wheel_mode, set_scroll_wheel_mode_on, set_smartshift,
